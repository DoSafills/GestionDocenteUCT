        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input value={formulario.descripcion} onChange={(e) => setFormulario(prev => ({ ...prev, descripcion: e.target.value }))} />
            </div>
            ...
            <div className="flex items-center gap-2">
              <Label>Activa</Label>
              <Switch checked={formulario.activa} onCheckedChange={(v) => setFormulario(prev => ({ ...prev, activa: v }))} />
            </div>
